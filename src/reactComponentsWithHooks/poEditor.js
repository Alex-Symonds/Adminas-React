...
// || Hook
export function usePOEditor(closeFn, poData, onSubmit, onDelete){
    const [reference, setReference] = useState(poData.reference);
    const [dateOnPo, setDateOnPo] = useState(poData.date_on_po);
    const [dateReceived, setDateReceived] = useState(poData.date_received);
    const [currency, setCurrency] = useState(poData.currency);
    const [poValue, setPoValue] = useState(poData.value);
...
// || Components
export function JobPoEditor({ closeFn, data, form_id, onDelete, onSubmit, title }){
    const {
        backend_error,
        controlled,
        handle_delete,
        ...
        <Modal close={ closeFn }>
            <div className={"poEditor"}>
                ...
                { backend_error.message ?
                    ...
                    <form className="poEditor_form formy" id={ form_id }>
