...
// document.addEventListener('DOMContentLoaded', () => {
    ...
    // export const CLASS_STATUS_ELE_BUTTON = "statusEle_icon";
...
function setupTodoStatusEleToggletips(){
    const CLASS_STATUS_ELE = "statusEle";
...
setupTodoStatusEleToggletips();
    ...
    // export function hide_all_toggletips(){
    //     document.querySelectorAll(`.${CLASS_STATUS_ELE_MESSAGE}`).forEach(ele => {
    //         if(isDisplayed(ele)){
    //             hide_one_tooltip(ele);
    //         }
