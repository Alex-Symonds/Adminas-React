...
function createOneJobItemFormsetKit(actions_formset, data, form_index){
...
// || JobItems Creator
function JobItemsCreator({ actions_items, closeEditor, job_id }){
    const MAX_FORMS = 10;
    const KEY_PAIRS = [
...
function JobItemsCreatorRowRemoveButton({ handle_click }){
    return  <button 
                class="delete-panel formSet_removeItemButton" 
