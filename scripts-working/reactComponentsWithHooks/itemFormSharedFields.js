...
// || Hook
function useProductDescription(initDescription, job_id){
...
function JobItemSharedFormFields({ controlled, initDescription, job_id, prefix }){
    const {
        description,
        update_product_description
