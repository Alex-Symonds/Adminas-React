...
*/
// || Hook
function usePriceCheckEditor(calc, closeFn, itemsActions, ji_id){
...
// || Components
function JobPriceCheckPriceEditorUI({ calc, cancel, controlledPrice, data, handle_change, handle_list_click, handle_resale_click, handle_submit }){
    return [
...
function PresetPriceButtonUI({ handle_click, price_type, price_preset }){
    return  <button 
                class="priceCheckEditor_presetPriceButton buttonSecondary" 
