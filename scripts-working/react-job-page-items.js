...
// || Main section
function JobItemsUI({ actions_items, currency, items_list, job_id, modalKit, URL_MODULE_MANAGEMENT }){
    ...
    return [
        <section class="jobItems jobNarrowSection">
            ...
            { items_list === undefined || items_list === null || items_list.length === 0 
                ? <EmptySectionUI 
...
function JobItemRowUI({ data, detailsKit, toggle_details }){
    ...
    return [
        <tr class={tr_css}>
            ...
            <td class="more_info">
                <button 
                    class={`more-icon${dark_icon_css === null ? '' : ' ' + dark_icon_css}`} 
...
function JobItemRowModularContentsUI({ css, data }){
    ...
    return  <div class={`${ css !== null && modularStatusCSS !== null
...
// || Helpers
function getJobItemModularStatusCSS(data){
